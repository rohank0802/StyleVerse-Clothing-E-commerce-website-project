      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-6">
        <div className="w-full max-w-xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-slate-900/70 border border-white/15 p-8 sm:p-10 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.6)] text-center flex flex-col items-center gap-6">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-rose-500/10 border border-rose-500/30 text-rose-400 text-xs font-medium tracking-wide">
            ...
            <div className="relative">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-tr from-indigo-900/60 to-rose-900/40 border border-white/20 flex items-center justify-center shadow-xl shadow-indigo-950/80">
                <svg className="w-10 h-10 text-rose-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <div className="absolute -bottom-1 -right-1 w-7 h-7 rounded-full bg-rose-500 border-2 border-slate-900 flex items-center justify-center text-white text-xs font-bold shadow-md">
                !
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-md mx-auto">
                You are currently signed in as a <span className="text-rose-300 font-semibold underline decoration-rose-500/40 underline-offset-4">Buyer</span>. Buyer accounts cannot view or manage seller dashboard features.
              </p>
            </div>
            ...
            <div className="w-full bg-indigo-950/50 border border-indigo-500/30 rounded-2xl p-4 text-left flex items-start gap-3.5 text-xs sm:text-sm text-slate-200">
              ...
              <div className="space-y-1">
                <p className="font-semibold text-white">Want to start selling on StyleVerse?</p>
                <p className="text-slate-300 text-xs leading-relaxed">
                  Join our curated network of designers & boutiques. Create a dedicated Seller account to showcase your brand to thousands of global buyers.
                </p>
              </div>
            </div>
...
export default BuyerAccessDenied
